...
게임 커뮤니티를 Steam 뉴스로 최신 상태로 유지하는 데 더 이상 수동 작업이나 프로그래밍 기술이 필요하지 않습니다. 이 가이드는 [Animoca Minds](https://animocaminds.ai/)를 사용한 노코드 자동화를 설정하여 [Steam](https://store.steampowered.com/)의 RSS 피드를 모니터링하고 매일 뉴스 요약을 Discord 채널이나 이메일 받은 편지함에 자동으로 전달하는 방법을 안내합니다.
...
- [Animoca Minds](https://animocaminds.ai/) 계정
...
1. [animocaminds.ai](https://animocaminds.ai/)를 방문하여 로그인하거나 계정을 만듭니다.
...
1. AI 에이전트와의 대화에서 Steam 스킬을 로드하도록 지시합니다:
   ...
   Animoca Minds에서 찾을 수 있습니다. 아티팩트 ID가 변경된 경우: *"사용 가능한 Steam 아티팩트를 나열해주세요."*라고 물어보세요.
